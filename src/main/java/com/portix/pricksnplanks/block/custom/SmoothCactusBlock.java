...
public class SmoothCactusBlock extends Block {
    public static final MapCodec<SmoothCactusBlock> CODEC = createCodec(SmoothCactusBlock::new);
    ...
    @Override
    public MapCodec<SmoothCactusBlock> getCodec() {
        return CODEC;
    }

    public SmoothCactusBlock(AbstractBlock.Settings settings) {
        super(settings);
